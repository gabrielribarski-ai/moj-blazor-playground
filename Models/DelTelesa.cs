...
namespace IzracunInvalidnostiBlazor.Models
{
    ...
    public class DelTelesa : ICloneable
    {
        ...
        /*
        [NotMapped]
        public bool JeZaklenjen =>
                FazaOcenjevanja.In(FazaOcenjevanjaEnum.OcenjevanjePotrjeno,FazaOcenjevanjaEnum.Zakljuceno);
        */
        ...
        public SegmentnaFaza SegmentnaFaza { get; set; } = SegmentnaFaza.NiOcene;
        [NotMapped]
        public bool JeZaklenjen => SegmentnaFaza == SegmentnaFaza.Zaklenjeno;
